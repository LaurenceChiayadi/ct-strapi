...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Content: Attribute.Component<'article.content', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiRoomTypeImageRoomTypeImage extends Schema.CollectionType {
  ...
  info: {
    singularName: 'room-type-image';
    pluralName: 'room-type-images';
    displayName: 'room type image';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::room-type-image.room-type-image',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
